...
# define digit_mul(u, v, hi, lo) \
    do { \
	mp_digit __u0 = (u); \
	mp_digit __u1 = __u0 >> MP_DIGIT_HSHIFT; __u0 &= MP_DIGIT_LMASK; \
	mp_digit __v0 = (v); \
	mp_digit __v1 = __v0 >> MP_DIGIT_HSHIFT; __v0 &= MP_DIGIT_LMASK; \
	mp_digit __lo = __u0 * __v0; \
	mp_digit __hi = __u1 * __v1; \
	__u1 *= __v0; \
...
/* Not worth inlining. */
#ifndef digit_div
# define digit_div(n1, n0, d, q, r) mp_digit_div((n1), (n0), (d), &(q), &(r))
#endif
